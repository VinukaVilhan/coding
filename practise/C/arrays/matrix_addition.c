...
void addMatrix(int rows1, int columns1, int rows2, int columns2, int firstArray[rows1][columns1], int secondArray[rows2][columns2], int resultArray[rows1][columns1]);
...
int main()
{
    ...
    {
        addMatrix(rows1, columns1, rows2, columns2, firstArray, secondArray, resultArray);
